...
public class AdapterListagemColeta extends BaseAdapter {
    private LayoutInflater mInflater;
    private ArrayList<Coleta> coletas;

    public AdapterListagemColeta(Context context, ArrayList<Coleta> coletas)
    {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        convertView = mInflater.inflate(R.layout.item_listagem_coleta, null);
